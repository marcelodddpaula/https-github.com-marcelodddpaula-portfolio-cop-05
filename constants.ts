...
export const IMAGES: ImageItem[] = [
  { id: 1, src: 'portfolio/letras-alto-relevo/caracol_ (1)', alt: 'Fachada moderna com letra caixa', title: 'Fachada Comercial', categories: ['Fachadas', 'Letras 3D'], tags: ['Letra Caixa', 'Relevo 3D'] },
  ...
  { id: 3, src: 'portfolio/letras-alto-relevo/caracol_ (3)', alt: 'Placa de consultório médico em relevo', title: 'Placa de Recepção', categories: ['Placas'], tags: ['Consultórios', 'Relevo e Adesivo'] },
  ...
  { id: 6, src: 'portfolio/fachadas/CrossFit_ (2)', alt: 'Placa para escritório de advocacia', title: 'Placa Advocacia', categories: ['Placas'], tags: ['Consultórios', 'Inox'] },
  { id: 7, src: 'portfolio/letras-alto-relevo/CrossFit_ (3)', alt: 'Fachada CrossFit com letra caixa', title: 'Academia', categories: ['Fachadas'], tags: ['Letra Caixa', 'Estrutura ACM'] },
  ...
  { id: 14, src: 'testeportfolio-01/uxjl792ioidgyuiwhtrv', alt: 'Letra em relevo com pintura de alumínio', title: 'Letra Alumínio', categories: ['Letras Alto Relevo'], tags: ['Pintura Alumínio'] },
  { id: 15, src: 'IMG-20150519-WA0002_g2yvbs', alt: 'Totem moderno para empresa de engenharia', title: 'Totem Corporativo', categories: ['Totem'], tags: ['Iluminado', 'ACM e Adesivos'] },
  { id: 16, src: 'main-sample', alt: 'Adesivo de parede para decoração de escritório', title: 'Decoração de Parede', categories: ['Adesivos'], tags: ['Paredes'] },
  { id: 17, src: 'cld-sample-2', alt: 'Letras douradas para recepção de hotel', title: 'Recepção de Luxo', categories: ['Letras Alto Relevo'], tags: ['Pintura Dourada', 'Inox'] },
];
